...
def main(hp: DictConfig):
    ...
    data_types = pd.read_csv("../data/g_A001_data_types.csv")

    artifacts_dir = "./outputs/2023-11-17/15-57-27/mlruns/0/e8dc00646b3b4a1f9be7600006a27271/artifacts/"  # epochs: 5000
