...
# Read the data_real.csv data
real_data_path = os.path.join(base_path, 'data_real.csv')
...
for subdir, dirs, files in tqdm(os.walk(generations_folder)):
    if 'data_fake.csv' in files:
        fake_data_path = os.path.join(subdir, 'data_fake.csv')
